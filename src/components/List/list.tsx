...
const rows = [
  { id: 1, lastName: 'Snow', firstName: 'Jon', age: 35 , Fokotany: 'Ambohipo'},
        ...
        <DialogContent>
          ...
          <Box
              sx={{
                ...
                <TextField id="standard-basic" label="Nom" value={currentRow?.row?.firstName} disabled />
                <TextField id="standard-basic" label="Prénom" value={currentRow?.row?.lastName} disabled style={{marginTop: "10px"}}/>
                <TextField id="standard-basic" label="Age" value={currentRow?.row?.age} disabled style={{marginTop: "10px"}}/>              
            </Box>
